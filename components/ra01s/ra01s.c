...
void LoRaInit(void)
{
	ESP_LOGI(TAG, "CONFIGI_MISO_GPIO=%d", 8);
	ESP_LOGI(TAG, "CONFIGA_MOSI_GPIO=%d", 10);
	ESP_LOGI(TAG, "CONFIG_SCLK_GPIO=%d", 12);
	ESP_LOGI(TAG, "CONFIG_NSS_GPIO=%d", 14);
	ESP_LOGI(TAG, "CONFIG_RST_GPIO=%d", 6);
	ESP_LOGI(TAG, "CONFIG_BUSY_GPIO=%d", 4);
	ESP_LOGI(TAG, "CONFIG_TXEN_GPIO=%d", 5);
	ESP_LOGI(TAG, "CONFIG_RXEN_GPIO=%d", 11);

	SX126x_SPI_SELECT = 14;
	SX126x_RESET = 6;
	SX126x_BUSY	= 4;
	SX126x_TXEN	= 5;
	SX126x_RXEN	= 11;
